---
name: create-tasks
description: Generates step-by-step task lists in Markdown based on PRDs, ensuring each parent task is a complete vertical slice.
---

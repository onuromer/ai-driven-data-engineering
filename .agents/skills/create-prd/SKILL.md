---
name: create-prd
description: Guides the creation of a clear, actionable PRD from a user's feature request by first asking clarifying questions.
---
...
<overview>
This guide helps you generate detailed Product Requirements Documents (PRDs) in Markdown format based on user requests. PRDs must be clear, actionable, and suitable for junior developers to understand and implement.
</overview>

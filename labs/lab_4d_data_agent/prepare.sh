...
# Usage: bash labs/lab_4d_data_agent/prepare.sh ~/my-pokedex-project
...
echo ""
echo "==> Preparing Lab 4d: Copying Lab 3 solutions to $PROJECT_DIR"
...
echo ""
echo "==> Ready for Lab 4d!"
echo "    Follow the instructions in labs/lab_4d_data_agent/README.md"

# Lab 4d — Prepare: Copy Lab 0-3 solutions and ensure DuckDB has data
# Usage: .\labs\lab_4d_data_agent\prepare.ps1 -ProjectDir ~\my-pokedex-project
...
Write-Host ""
Write-Host "==> Preparing Lab 4d: Copying Lab 3 solutions to $ProjectDir"
...
Write-Host ""
Write-Host "==> Ready for Lab 4d!"
Write-Host "    Follow the instructions in labs\lab_4d_data_agent\README.md"

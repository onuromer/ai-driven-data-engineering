select
    ...
    cast(moves.name as varchar) as move_name,
    ...
    cast(moves.type__name as varchar) as move_type,
    cast(moves.damage_class__name as varchar) as damage_class,
    cast(moves.generation__name as varchar) as generation_name,

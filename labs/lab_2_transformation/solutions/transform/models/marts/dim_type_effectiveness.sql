...
damage_relations as (
    select
        ...
        cast(2.0 as double) as damage_multiplier
    from standard_types as attacking
    ...
    select
        ...
        cast(0.5 as double) as damage_multiplier
    from standard_types as attacking
    ...
    select
        ...
        cast(0.0 as double) as damage_multiplier
    from standard_types as attacking
...
select
    ...
    coalesce(damage_relations.damage_multiplier, cast(1.0 as double)) as damage_multiplier
from type_pairs

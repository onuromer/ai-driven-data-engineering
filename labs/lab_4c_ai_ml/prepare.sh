...
# Usage: bash labs/lab_4c_ai_ml/prepare.sh ~/my-pokedex-project
...
echo ""
echo "==> Preparing Lab 4c: Copying Lab 3 solutions to $PROJECT_DIR"
...
echo ""
echo "==> Ready for Lab 4c!"
echo "    Follow the instructions in labs/lab_4c_ai_ml/README.md"

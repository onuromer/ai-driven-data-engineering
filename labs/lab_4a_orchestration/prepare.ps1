...
# Usage: .\labs\lab_4a_orchestration\prepare.ps1 -ProjectDir ~\my-pokedex-project
...
Write-Host ""
Write-Host "==> Ready for Lab 4a!"
Write-Host "    Follow the instructions in labs\lab_4a_orchestration\README.md"
